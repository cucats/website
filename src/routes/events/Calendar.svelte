<script lang="ts">
    ...
    const allTerms = [
        { name: "Michaelmas 2025", start: new Date("2025-10-09"), type: "michaelmas" },
                ...
                <div class="grid grid-cols-[30px_repeat(7,_152px)] gap-2">
                    ...
                    {#each [0, 1, 2, 3, 4, 5, 6] as day}
                        ...
                        {@const cellDate = new Date(
                            currentTerm.start.getTime() + (week * 7 + day) * 24 * 60 * 60 * 1000,
                        )}
                        ...
                        <div
                            class="h-32 rounded p-1 {isWeekend
                                ? 'bg-neutral-700/30'
                                : 'bg-neutral-800/30'} {isToday ? 'ring-secondary-700 ring-2' : ''}"
                        >
                            <!-- Day of month -->
...
>
    {#if selectedEvent}
        ...
        <div class="pr-8">
            <h2 class="mb-4 text-2xl font-bold text-neutral-100">{selectedEvent.summary}</h2>
            ...
            <div class="c-4">
                ...
                {#if selectedEvent.description}
                    <MetadataItem icon="/assets/icons/description.png" title="Description">

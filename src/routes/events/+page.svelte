        ...
        <div class="c-4 p-4-8 mx-auto max-w-screen-lg">
            ...
            <div class="c-4">
                ...
                <Event website="https://forms.gle/5BNss8APeFZdZEgG9">
                    ...
                    {#snippet description()}
                        AI alignment talk by Hoagy Cunningham, free food provided by Aromi, Claude
                        demo with Greg Feingold, and a fast-paced, informal hackathon. All
                        participants will receive $50 of free Anthropic API Credits, with additional
                        prizes for winners.
                    {/snippet}
                </Event>
                ...
                <Event website="https://forms.gle/mNsgPnroizzu7NvbA">
                    ...
                    {#snippet description()}
                        Sunoo Park: Two Tales of End-to-End Encryption. This talk explores two
                        emerging threats to end-to-end encryption, including government and
                        commercial circumvention. It examines the Encrochat hack, as well as the
                        risks posed by the growing integration of AI into communication platforms.
                        There will be a free dinner at Pho afterwards.
                    {/snippet}
                </Event>
                ...
                >
                    ...
                    {#snippet description()}
                        Supported by Arm and Anthropic. Join for an exciting opportunity to build
                        innovative AI agent applications.
                    {/snippet}
                </Event>
                ...
                <Event website="https://camgamejam.com" logo="/assets/events/jam.png">
                    ...
                    {#snippet description()}
                        The Game Jam is similar to a hackathon: you have 48h to develop a game that
                        fits a specific theme (revealed at the beginning of the event).
                    {/snippet}
                </Event>
                ...
                <Event website="https://aoc.cucats.org/about">
                    ...
                    {#snippet description()}
                        Inspired by the global Advent of Code, our version adds a CUCaTS twist! Each
                        day at 12:00 p.m., a new challenge will be posted for you to solve and earn
                        points.
                    {/snippet}
                </Event>
                ...
                <Event website="https://camhack.org" logo="/assets/events/camhack.png">
                    ...
                    {#snippet description()}
                        ...
                        design and build technology projects from the ground up.
                    {/snippet}
                </Event>
            </div>
        </div>

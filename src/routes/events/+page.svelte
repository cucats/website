      ...
      <div class="c-4 mx-auto max-w-5xl p-4">
        ...
        <div class="c-4">
          <Event website="https://forms.gle/5BNss8APeFZdZEgG9">
            ...
            {#snippet description()}
              AI alignment talk by Hoagy Cunningham, free food provided by
              Aromi, Claude demo with Greg Feingold, and a fast-paced, informal
          ...
          <Event website="https://forms.gle/mNsgPnroizzu7NvbA">
            ...
            {#snippet description()}
              ...
              two emerging threats to end-to-end encryption, including
              government and commercial circumvention. It examines the Encrochat
              hack, as well as the risks posed by the growing integration of AI
              into communication platforms. There will be a free dinner at Pho
              afterwards.
            {/snippet}
          </Event>
          ...
          >
            ...
            {#snippet description()}
              Supported by Arm and Anthropic. Join for an exciting opportunity
              to build innovative AI agent applications.
            {/snippet}
          </Event>
          ...
          <Event
            ...
            logo="/assets/events/camhack.png"
          >

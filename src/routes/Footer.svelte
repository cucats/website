<script lang="ts">
  ...
  const socialLinks = [
    {
      name: "Instagram",
      href: "https://www.instagram.com/cucats.cam",
      icon: "/assets/socials/instagram.svg",
    },
    {
      name: "Facebook",
      href: "https://www.facebook.com/CUCaTS",
      icon: "/assets/socials/facebook.png",
    },
    {
      name: "X",
      href: "https://x.com/cucatscam",
...
<footer class="bg-primary-950 border-t border-neutral-800">

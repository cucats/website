  ...
  <section class="bg-secondary-800 pt-24 text-neutral-300">
    <div class="mx-auto max-w-4xl px-4 py-12">
      ...
      <nav class="mb-6 text-sm text-neutral-400">
        ...
        <span class="text-neutral-300">Blog</span>
      </nav>
      ...
      <div class="space-y-6">
        {#each data.posts as post}
          <article
            class="group bg-secondary-700 hover:border-primary-500 hover:bg-secondary-600 rounded-lg border border-neutral-600 p-6 transition-colors"
          >
            <a href="/blog/{post.slug}" class="block">
              <div
                class="mb-2 flex items-center gap-3 text-xs text-neutral-500"
              >
              ...
              {#if post.description}
                <p class="text-sm text-neutral-400">{post.description}</p>
              {/if}
              <span

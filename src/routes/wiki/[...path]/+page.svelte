    ...
    <div class="mx-auto max-w-4xl px-4 py-12">
      ...
      {#if data.breadcrumbs.length > 0}
        <nav class="text-secondary-300 mb-6 text-sm">
          <a href="/wiki" class="hover:text-primary-400 hover:underline">Wiki</a
          >
      ...
      <article>
        ...
        {#if data.sections.length > 0}
          <nav class="bg-secondary-700 mb-8 rounded-lg p-4">
            ...
            <ul class="space-y-1">
              {#each data.sections as section}
                <li>
                  <a
                    href="#{section.slug}"
                    class="text-secondary-200 hover:text-neutral-100 hover:underline"
                  >
                    {section.title}
                  </a>
                </li>

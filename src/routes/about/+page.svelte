    ...
    <section class="bg-secondary-800 pt-24 text-neutral-300">
        <div class="c-4 p-4-8 mx-auto max-w-screen-lg">
            ...
            <p>
                ...
                the primary student-run computing society at Cambridge. We aim to provide a platform
                for students to explore and engage with technology, regardless of their degree or
                experience level.
            </p>
            <p>
        ...
        <div class="c-4 p-4-8 mx-auto max-w-screen-lg">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div class="c-4 bg-opacity-40 p-4-8 rounded-lg bg-neutral-800">
                    ...
                    <p>Provide a forum to discuss topics and issues concerning computing and IT</p>
                </div>
            </div>
        </div>
    </section>
                ...
                {#snippet committeeMember(role: string, name: string)}
                    <div class="min-w-40 md:min-w-64">
                        <div class="text-sm md:text-base">
                            <span class="block font-bold lowercase md:inline">{role}</span><span
                                class="inline text-neutral-300 opacity-60">@cucats.org</span
                            >
                        </div>
                        <div class="text-xl font-medium tracking-tight md:text-2xl">{name}</div>
                    </div>
                {/snippet}
